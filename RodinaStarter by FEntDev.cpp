...
int main() {
    ...
    case 1:
        ...
        std::cout << "Вы успешно запускаетесь на Центральный Округ(ЦО), просьба не закрывать это окно при игре.\nВо избежании проблем рекомендуем выходить из игры командой /quit(/q)";
        break;
    case 2:
        command = "gta_sa.exe -c -h " + YO + " -p 7777 -n " + Nick_Name + " -rodina -z -mem 4096 -ldo";
        std::cout << "Вы успешно запускаетесь на Южный Округ(ЮО), просьба не закрывать это окно при игре.\nВо избежании проблем рекомендуем выходить из игры командой /quit(/q)";
        break;
    case 3:
        command = "gta_sa.exe -c -h " + SO + " -p 7777 -n " + Nick_Name + " -rodina -z -mem 4096 -ldo";
        std::cout << "Вы успешно запускаетесь на Северный Округ(СО), просьба не закрывать это окно при игре.\nВо избежании проблем рекомендуем выходить из игры командой /quit(/q)";
        break;
    case 4:
        command = "gta_sa.exe -c -h " + VO + " -p 7777 -n " + Nick_Name + " -rodina -z -mem 4096 -ldo";
        std::cout << "Вы успешно запускаетесь на Восточный Округ(ВО), просьба не закрывать это окно при игре.\nВо избежании проблем рекомендуем выходить из игры командой /quit(/q)";
        break;
    case 5:
        command = "gta_sa.exe -c -h " + ZO + " -p 7777 -n " + Nick_Name + " -rodina -z -mem 4096 -ldo";
        std::cout << "Вы успешно запускаетесь на Западный Округ(ЗО), просьба не закрывать это окно при игре.\nВо избежании проблем рекомендуем выходить из игры командой /quit(/q)";
        break;
    case 6:
        command = "gta_sa.exe -c -h " + PO + " -p 7777 -n " + Nick_Name + " -rodina -z -mem 4096 -ldo";
        std::cout << "Вы успешно запускаетесь на Приморский Округ(ПО), просьба не закрывать это окно при игре.\nВо избежании проблем рекомендуем выходить из игры командой /quit(/q)";
        break;
    default:
